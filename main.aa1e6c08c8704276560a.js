        ...
        function n(t) {
            ...
            return (
                ...
                (1 == t.deltaMode ?
                    ...
                    ((s *= 800), (r *= 800))),
                s && !e && (e = s < 1 ? -1 : 1),
                r && !i && (i = r < 1 ? -1 : 1), { spinX: e, spinY: i, pixelX: s, pixelY: r }
            )
        };
        ...
        function v() {
            if (!w) {
                ...
                var t = navigator.userAgent,
                    e = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(
                        t
                    ),
                    v = /(Mac OS X)|(Windows)|(Linux)/.exec(t)
                if (
                    ((g = /\b(iPhone|iP[ao]d)/.exec(t)),
                        (p = /\b(iP[ao]d)/.exec(t)),
                        (c = /Android/i.exec(t)),
                        (m = /FBAN\/\w+;/i.exec(t)),
                        (f = /Mobile/i.exec(t)),
                    ...
                    (n = e[4] ? parseFloat(e[4]) : NaN) ?
                    ((e = /(?:Chrome\/(\d+\.\d+))/.exec(t)),
                        (h = e && e[1] ? parseFloat(e[1]) : NaN)) :
                    (h = NaN)
                } else i = s = r = h = n = NaN
                if (v) {
                    if (v[1]) {
    ...
    function(t, e, i) {
            ...
            applyMatrix4(t) {
                return (
                    (function(t, e, i) {
                        ...
                        (h = h || 1),
                        (t[0] = (i[0] * s + i[4] * r + i[8] * n + i[12]) / h),
                        (t[1] = (i[1] * s + i[5] * r + i[9] * n + i[13]) / h),
                        (t[2] = (i[2] * s + i[6] * r + i[10] * n + i[14]) / h)
                    })(this, this, t),
                    this
                )
            }
                ...
                return (
                    (function(t, e, i) {
                        let s = e[0],
                            ...
                            h = i[3] * s + i[7] * r + i[11] * n + i[15];
                        (h = h || 1),
                        (t[0] = (i[0] * s + i[4] * r + i[8] * n) / h),
                        (t[1] = (i[1] * s + i[5] * r + i[9] * n) / h),
                        (t[2] = (i[2] * s + i[6] * r + i[10] * n) / h)
                    })(this, this, t),
                    this
                )
            }
        ...
        class f {
            constructor({
                ...
                2 === d && (this.gl = t.getContext('webgl2', g)),
                    ...
                    this.gl ||
                    (this.gl =
                        t.getContext('webgl', g) ||
                        t.getContext('experimental-webgl', g)),
                ...
                if (
                    ...
                    r.forEach(r => {
                            r.program.transparent ?
                                ...
                                r.program.depthTest &&
                                e &&
                                (r.worldMatrix.getTranslation(p),
                                    p.applyMatrix4(e.projectionViewMatrix),
                                    (r.zDepth = p.z))
                        }),
        ...
        class M extends Array {
            ...
            set(t, e, i, s) {
                return t.length ?
                    this.copy(t) :
                    (x(this, t, e, i, s), this.onChange(), this)
            }
            rotateX(t) {
                return (
                    (function(t, e, i) {
            ...
            return function(e, i) {
                ...
                return (
                    ...
                    ((w = 2 * Math.sqrt(f + 1)),
                        ...
                        (e[2] = (o - u) / w)) :
                    a > c && a > m ?
                    ((w = 2 * Math.sqrt(1 + a - c - m)),
                        (e[3] = (d - p) / w),
                        (e[0] = 0.25 * w),
                        (e[1] = (o + u) / w),
                        (e[2] = (g + l) / w)) :
                    c > m ?
                    ((w = 2 * Math.sqrt(1 + c - a - m)),
                        (e[3] = (g - l) / w),
                        (e[0] = (o + u) / w),
                        (e[1] = 0.25 * w),
                        (e[2] = (d + p) / w)) :
                    ((w = 2 * Math.sqrt(1 + m - a - c)),
                        (e[3] = (o - u) / w),
                        (e[0] = (g + l) / w),
                        (e[1] = (d + p) / w),
                        (e[2] = 0.25 * w)),
                ...
                return (
                    (function(t, e, i) {
                        let s,
                            ...
                            w = i[2]
                        e === t ?
                            ((t[12] = e[0] * m + e[4] * f + e[8] * w + e[12]),
                                (t[13] = e[1] * m + e[5] * f + e[9] * w + e[13]),
                                (t[14] = e[2] * m + e[6] * f + e[10] * w + e[14]),
                                (t[15] = e[3] * m + e[7] * f + e[11] * w + e[15])) :
                            ((s = e[0]),
                                (r = e[1]),
                                (n = e[2]),
                                (h = e[3]),
            ...
            lookAt(t, e, i) {
                return (
                    (function(t, e, i, s) {
                        ...
                        0 === g ?
                            (d = 1) :
                            ((g = 1 / Math.sqrt(g)), (u *= g), (c *= g), (d *= g))
                        let p = o * d - l * c,
                            m = l * u - a * d,
                            f = a * c - o * u;
                        (g = p * p + m * m + f * f),
                        0 === g &&
                            (l ? (a += 1e-6) : o ? (l += 1e-6) : (o += 1e-6),
                                (p = o * d - l * c),
                                (m = l * u - a * d),
                                (f = a * c - o * u),
                                (g = p * p + m * m + f * f)),
        ...
        class I extends R {
            ...
            unproject(t) {
                return (
                    t.applyMatrix4(P.inverse(this.projectionMatrix)),
            ...
            frustumIntersectsMesh(t) {
                ...
                if (
                    ((t.geometry.bounds && t.geometry.bounds.radius !== 1 / 0) ||
                        t.geometry.computeBoundingSphere(), !t.geometry.bounds)
                )
                    return !0
                const e = C
        ...
        class O {
            ...
            computeBoundingSphere(t) {
                ...
                for (let i = 0, s = t.length; i < s; i += 3)
                    U.fromArray(t, i),
                    (e = Math.max(e, this.bounds.center.squaredDistance(U)))
        ...
        class z extends O {
            constructor(
                ...
                z.buildPlane(u, c, d, g, e, i, 0, h, a),
                    Object.assign(n, {
                    ...
                    if (
                        ...
                        this.generateMipmaps &&
                            (this.gl.renderer.isWebgl2 ||
                                (V(this.image.width) && V(this.image.height)) ?
                        ...
                        if (
                            (i.isStruct &&
                                ...
                                ((r = r[i.structIndex][i.structProperty]),
                                    (s += `[${i.structIndex}].${i.structProperty}`)), !r)
                        )
                            return J(`Active uniform ${s} has not been supplied`)
                        if (r && void 0 === r.value)
                            return J(s + ' uniform is missing a value parameter')
                        if (r.value.texture)
                            return (e += 1), r.value.update(e), $(this.gl, i.type, t, e)
        ...
        class ht {
            constructor(
                ...
                (this.gl = t),
                (this.options = { wrapS: r, wrapT: n, minFilter: h, magFilter: a }),
                (this.passes = []),
                (this.geometry = o),
            ...
            addPass({
                ...
                const n = new Z(this.gl, { vertex: t, fragment: e, uniforms: i }),
                    h = {
                        mesh: new st(this.gl, { geometry: this.geometry, program: n }),
                        program: n,
                        uniforms: i,
                        enabled: r,
                        textureUniform: s
            ...
            render({
                ...
                this.gl.renderer.render({
                        scene: t,
                        camera: e,
                        target: h.length || (!i && this.targetOnly) ? this.fbo.write : i,
                        update: s,
                        sort: r,
                        frustumCull: n
                    }),
                    this.fbo.swap(),
                    h.forEach((t, e) => {;
                        (t.mesh.program.uniforms[
                            t.textureUniform
                        ].value = this.fbo.read.texture),
                        this.gl.renderer.render({
                                scene: t.mesh,
                                target: e !== h.length - 1 || (!i && this.targetOnly) ?
                                    this.fbo.write :
                                    i,
                                clear: !0
                            }),
        ...
        new [
            class {
                ...
                createRenderer() {;
                    (this.renderer = new f({ alpha: !0 })),
                    (this.gl = this.renderer.gl),
                    document.body.appendChild(this.gl.canvas)
                }
                createCamera() {;
                    (this.camera = new I(this.gl)),
                    (this.camera.fov = 45),
                ...
                createMedias() {;
                    ...
                    (this.medias = Array.from(this.mediasElements).map(
                        ...
                        new(class {
                            ...
                            createMesh() {
                                const t = new Image(),
                                    e = new j(this.gl, { generateMipmaps: !1 });
                                (t.src = this.image.src),
                                (t.onload = s => {;
                                    (i.uniforms.uImageSizes.value = [
                                        t.naturalWidth,
                                        t.naturalHeight
                                    ]),
                                    (e.image = t)
                            ...
                            update(t, e) {
                                ...
                                'up' === e &&
                                    ...
                                    (this.plane.program.uniforms.uStrength.value =
                                        ((t.current - t.last) / this.screen.width) * 10)
                            }
                            onResize(t) {
                                if (((this.extra = 0), t)) {
                ...
                update() {;
                    ...
                    (this.scroll.current = q(
                        this.scroll.current,
                        this.scroll.target,
                        this.scroll.ease
                    )),
                    this.scroll.current > this.scroll.last ?
                        ((this.direction = 'down'), (this.speed = 2)) :
                        this.scroll.current < this.scroll.last &&
                        ((this.direction = 'up'), (this.speed = -2)),
                        this.medias &&
                        this.medias.forEach(t => t.update(this.scroll, this.direction)),
            ...
            class {
                            ...
                            update(t, e) {
                                ...
                                'down' === e &&
                                    ...
                                    ((this.extra += this.width),
                                        ...
                                        (this.isAfter = !1)),
                                    (this.plane.program.uniforms.uStrength.value =
                                        ((t.current - t.last) / this.screen.width) * 5)
                            }
                            onResize(t) {
                                if (((this.extra = 0), t)) {
                ...
                onResize() {;
                    ...
                    this.post.resize(),
                        ...
                        (this.galleryBounds = this.gallery.getBoundingClientRect()),
                        (this.galleryWidth =
                            (this.viewport.width * this.galleryBounds.width) /
                            this.screen.width),
                        this.medias &&
                        this.medias.forEach(t =>
                            t.onResize({
                ...
                update() {;
                    ...
                    this.scroll.current > this.scroll.last ?
                        ...
                        this.medias &&
                        this.medias.forEach(t => t.update(this.scroll, this.direction)),
                        (this.pass.uniforms.uStrength.value =
                            ((this.scroll.current - this.scroll.last) / this.screen.width) *
                            0.5),
