...
parcelRequire = (function(modules, cache, entry, globalName) {
    ...
    "DP3g": [function(require, module, exports) {
        "use strict";
        ...
        Promise.all([(0, _utils.preloadImages)(), (0, _utils.preloadFonts)('xha3hij')]).then(function() {
            ...
            lscroll.on('scroll', function(obj) {
                ...
                var transformVal = {
                    translateY: (0, _utils.map)(distance, 150, -150, -90, 90),
                    rotate: (0, _utils.map)(distance, 150, -150, -15, 15),
                    scale: (0, _utils.map)(Math.abs(distance), 0, 50, 1, 0.5)
                    ...
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                        ...
                        try {
                            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                                ...
                                char.style.transform = "scale3d(".concat(transformVal.scale, ",").concat(transformVal.scale, ",").concat(transformVal.scale, ") rotate3d(0,0,1,").concat(j < charsTotal / 2 ? Math.abs(factor - charsTotal / 2) * transformVal.rotate : -1 * Math.abs(factor - charsTotal / 2) * transformVal.rotate, "deg) translate3d(0,").concat(factor * transformVal.translateY, "px,0)");
                            }
                        } catch (err) {
                            _iterator2.e(err);
                        } finally {
                ...
                for (var _i = 0, _Object$keys = Object.keys(obj.currentElements); _i < _Object$keys.length; _i++) {
                    ...
                    if (obj.currentElements[key].el.classList.contains('content__img')) {
                        ...
                        var rotate = (0, _utils.map)(progress, 0, 1, -5, 5);
                        obj.currentElements[key].el.style.transform = "rotate3d(0,0,1,".concat(rotate, "deg)");
                    }
                }
            });
        });
    }, { "./utils": "MgTz", "locomotive-scroll": "ez7q", "splitting/dist/splitting.css": "oR66", "splitting/dist/splitting-cells.css": "yIBK", "splitting": "Qdhu" }]
}, {}, ["DP3g"], null)
